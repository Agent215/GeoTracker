...
export const GibsUrls = {
    ...
    ["clouds"]: "https://gibs.earthdata.nasa.gov/wmts/epsg3857/best/" + 
        "VIIRS_SNPP_Cloud_Effective_Radius/default/default/" + 
        "GoogleMapsCompatible_Level7/{z}/{y}/{x}.png",
    ["precipitation"]: "https://gibs.earthdata.nasa.gov/wmts/epsg3857/best/" + 
        "IMERG_Precipitation_Rate/default/default/" + 
        "GoogleMapsCompatible_Level6/{z}/{y}/{x}.png",
    ["pressure"]: "https://gibs.earthdata.nasa.gov/wmts/epsg3857/best/" + 
        "AIRS_L2_RelativeHumidity_500hPa_Day/default/default/" + 
        "GoogleMapsCompatible_Level6/{z}/{y}/{x}.png",
    ["wind"]: "https://gibs.earthdata.nasa.gov/wmts/epsg3857/best/" + 
        "CYGNSS_L3_Wind_Speed_Daily/default/default/" + 
        "GoogleMapsCompatible_Level6/{z}/{y}/{x}.png",
    ["temp"]: "https://gibs.earthdata.nasa.gov/wmts/epsg3857/best/" + 
        "AIRS_L2_Surface_Skin_Temperature_Day/default/default/" + 
        "GoogleMapsCompatible_Level6/{z}/{y}/{x}.png",
}
